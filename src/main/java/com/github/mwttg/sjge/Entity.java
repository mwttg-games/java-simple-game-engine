...
public class Entity {
    ...
    public boolean equals(Object o) {
        ...
        return vertexArrayObjectId == entity.vertexArrayObjectId && textureId == entity.textureId && size == entity.size && Float.compare(entity.positionX, positionX) == 0 && Float.compare(entity.positionY, positionY) == 0 && Float.compare(entity.positionZ, positionZ) == 0 && uuid.equals(entity.uuid);
    }

    @Override
    public int hashCode() {
        return Objects.hash(uuid, vertexArrayObjectId, textureId, size, positionX, positionY, positionZ);
    }
